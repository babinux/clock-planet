...
_exports.$litElement=litElement;var planetClockElement=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(planetClockElement,_LitElement);babelHelpers.createClass(planetClockElement,null,[{key:"properties",/**
...
_this11.loaded=!1;// this.date = new Date();
...
}}],[{key:"styles",get:function get(){var request=new XMLHttpRequest;request.open("GET","./src/style.css",!1);request.send();return[css(_templateObject2_2384b1e0230c11ea83494f01adba82ef(),unsafeCSS(request.responseText))]}}]);return planetClockElement}(LitElement);// Register the element with the browser
